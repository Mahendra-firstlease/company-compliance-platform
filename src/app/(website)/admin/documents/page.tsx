...
export default function DocumentsConfigPage() {
  return (
    <div className="bg-white rounded-lg border border-slate-200 p-8 text-center shadow-2xs space-y-3 animate-in fade-in duration-300">
      ...
      <h3 className="font-semibold text-slate-900 text-sm">Documents Settings</h3>
      <p className="text-xs text-slate-400 max-w-md mx-auto">
        Simulated admin data and processing configurations for documents logs are currently integrated with the main overview console.
      </p>
    </div>
  );
}
