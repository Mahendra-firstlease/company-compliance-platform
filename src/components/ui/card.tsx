...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-semibold text-slate-800 text-sm md:text-base leading-snug tracking-tight",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-xs text-slate-400 font-semibold leading-normal", className)}
      {...props}
    />
  );
}
...
function CardAction({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "col-start-2 row-span-2 row-start-1 self-start justify-self-end flex items-center shrink-0 ml-auto",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-(--card-spacing) text-sm text-slate-650 flex-1", className)}
      {...props}
    />
  );
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t border-slate-100 bg-slate-50/50 p-(--card-spacing) text-xs -mb-(--card-spacing) mt-2",
        className
      )}
      {...props}
    />
