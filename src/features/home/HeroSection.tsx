...
function HeroSection({}: Props) {
  return (
    <>
      <Section className='w-full bg-[url("/images/home/hero-section/hero-grid-gradient-img.png")] bg-cover bg-center bg-no-repeat px-4 pb-10'>
        <Container className="container flex flex-col-reverse md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-start">
            ...
            <p className="inline-flex gap-2 text-center lg:text-left text-sm text-neutral-600 mt-4">
              Popular:{" "}
              <span className="font-normal text-sm px-4 bg-gray-200 rounded-2xl">
                GST
              </span>{" "}
              <span className="font-normal text-sm px-4 bg-gray-200 rounded-2xl">
                FSSI
